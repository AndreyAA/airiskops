...
> Статус: реализовано. Документ сохранён как спецификация и журнал принятых
> решений. Актуальные команды запуска находятся в
> [local walkthrough](../runbooks/local-walkthrough.md), а результаты
> сравнительного НТ -- в [плане нагрузочного тестирования](load-testing-plan.md).
...
На момент подготовки документа целью было:
...
До реализации в репозитории не было удобного и инкапсулированного способа:
