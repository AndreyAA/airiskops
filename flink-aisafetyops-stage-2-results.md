...
2. `bash scripts/start-local.sh`
3. `./scripts/init-topics.sh`
4. `bash scripts/submit-job.sh`
5. `bash scripts/run-replay.sh --scenario mixed --requests 120 --sessions 12 --agent-id agent-risk-01`
