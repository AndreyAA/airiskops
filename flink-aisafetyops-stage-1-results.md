...
- `scripts/check-output-topics.sh`
- `scripts/run-regression.sh`

Добавлены supporting assets:

- `config/local-job.yaml`
...
- `docker-compose.yml` и `config/local-job.yaml` синхронизированы.
...
- добавлен `scripts/check-output-topics.sh`;
...
- [flink-aisafetyops-manual.md](/home/bob/old_bob/IdeaProjects/flink/flink-aisafetyops-manual.md)
- [flink-aisafetyops-mvp-spec.md](/home/bob/old_bob/IdeaProjects/flink/flink-aisafetyops-mvp-spec.md)
- [flink-aisafetyops-mvp-runbook.md](/home/bob/old_bob/IdeaProjects/flink/flink-aisafetyops-mvp-runbook.md)
- [flink-monitoring-debugging-guide.md](/home/bob/old_bob/IdeaProjects/flink/flink-monitoring-debugging-guide.md)
- [docker-compose.yml](/home/bob/old_bob/IdeaProjects/flink/docker-compose.yml)
- [config/local-job.yaml](/home/bob/old_bob/IdeaProjects/flink/config/local-job.yaml)
